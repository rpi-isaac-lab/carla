...
class PurePursuit:
    ...
    def get_control(self, waypoints, speed):
        ...
        self.lane_shift = self.lane_change_eval()
    ...
    def lane_change_eval(self):
        ...
        for point in self.blocked_points:
            dis_from_object_x = (t.location.x - point[0])
            dis_from_object_y = (t.location.y - point[1])
            if -10 < dis_from_object_x < 20 and -10 < dis_from_object_y < 20:
